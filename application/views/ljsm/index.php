                ...
                <div id="last_box_10">
                    <ul id="ul_box_10" class="a_tw2_css_4 clearfix">
                        <?php
                         ...
                         ?>
                                    <li><span><b><a href="cjwt/article20998.html" title="<?php echo $question['title']; ?>"><?php echo $question['title']; ?></a></b><p style="font-size:12px;"><?php echo $question['text'];?></p></span></li>
                        <?php
                                }
                            }else{
